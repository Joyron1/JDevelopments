...
export class FrameworksSliderComponent implements OnInit {
  ...
  public slides = [
    { id: 0, title: "Angular", img: "../../../assets/images/ourServicesImages/angular.png" },
    { id: 1, title: "Node.js", img: "../../../assets/images/ourServicesImages/node-js.png" },
    { id: 2, title: "MySQL", img: "../../../assets/images/ourServicesImages/mysql.png" },
    { id: 3, title: "Html5", img: "../../../assets/images/ourServicesImages/html5.png" },
    { id: 4, title: "Css3", img: "../../../assets/images/ourServicesImages/css3.png" },
    { id: 5, title: "Bootstrap", img: "../../../assets/images/ourServicesImages/bootstrap.png" },
    { id: 6, title: "JavaScript", img: "../../../assets/images/ourServicesImages/javascript.png" },
    { id: 7, title: "TypeScript", img: "../../../assets/images/ourServicesImages/typescript.png" },
    { id: 8, title: "React.js", img: "../../../assets/images/ourServicesImages/react.png" },
